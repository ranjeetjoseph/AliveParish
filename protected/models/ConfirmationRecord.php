...
class ConfirmationRecord extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('confirmation_dt, dob, baptism_dt', 'safe'),
			// array('dob, baptism_dt, confirmation_dt', 'date', 'format' => 'dd/MM/yyyy'),
			array('confirmation_dt, dob, baptism_dt', 'type', 'type' => 'date', 'message' => '{attribute}: is not a date!', 'dateFormat' => Yii::app()->locale->getDateFormat('short')),
			array('dob, baptism_dt, confirmation_dt', 'default', 'setOnEmpty' => true, 'value' => null),
